...
export class CsrfInterceptorService implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<any> {
        ...
        if (request.url.includes('https://baba.jrdatashu.win/jsonapi/node/videostore') || request.url.includes('https://baba.jrdatashu.win/api/courseoutline') || request.url.includes('https://baba.jrdatashu.win/api/courses?enrolled=0') || request.url.includes('https://baba.jrdatashu.win/api/courses?enrolled=1')) {
